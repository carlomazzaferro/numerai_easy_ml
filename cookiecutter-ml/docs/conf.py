...
latex_documents = [
    ('index',
     'cookiecutter-ml.tex',
     u'cookiecutter_ml Documentation',
...
texinfo_documents = [
    ('index', '{{ cookiecutter-ml }}', u'{{ cookiecutter_ml }} Documentation',
     u"{{ Carlo Mazzaferro }}", '{{ cookiecutter-ml }}',
     '{{ cookicutter machine learning }}', 'Miscellaneous'),
]
